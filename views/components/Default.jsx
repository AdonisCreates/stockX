...
<body>
      <div>
        ...
        <header style={{ backgroundColor: "green", justifyContent: "center" }}>
          <h1 style={{ textAlign: "center", color: "whitesmoke" }}>StockX</h1>
          ...
          <h1 style={{ textAlign: "center", color: "whitesmoke", backgroundColor: "black" }}>
            Authentic Sneakers
          </h1>
        </header>
        ...
        <nav>
          ...
          <a href="/shoes/new">Buy New Shoes</a>
          <br />
